...
import { FunnelFill, PlayFill } from "react-bootstrap-icons";
...
function SortNdFilter({ query, setQuery }) {
  ...
  return (  
    <aside>
      <button onClick={() => setShowFilters(!showFilters)} className="flex items-center justify-center gap-1 lg:hidden w-full px-3 py-2 mb-2 rounded-md text-white bg-primary hover:opacity-90">Filter & Sort <FunnelFill/> </button>
